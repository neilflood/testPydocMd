...
## Classes
### class AWSBatchComputeWorkerMgr
...
#### &nbsp;&nbsp;&nbsp;&nbsp; AWSBatchComputeWorkerMgr.getWorkerName(self, workerID)
        Return a string which uniquely identifies each work, including
        the jobName, if given.

#### &nbsp;&nbsp;&nbsp;&nbsp; AWSBatchComputeWorkerMgr.makeOutObjList(self)
        Make a list of all the objects the workers put into outqueue
        on completion

#### &nbsp;&nbsp;&nbsp;&nbsp; AWSBatchComputeWorkerMgr.setJobName(self, jobName)
        Sets the job name string, which is made available to worker
        processes. Defaults to None, and has only cosmetic effects.

#### &nbsp;&nbsp;&nbsp;&nbsp; AWSBatchComputeWorkerMgr.setupNetworkCommunication(self, userFunction, infiles, outfiles, otherArgs, controls, workinggrid, allInfo, blockList, numWorkers, inBlockBuffer, outBlockBuffer, forceExit, exceptionQue, workerBarrier)
...
### class ClassicBatchComputeWorkerMgr
...
#### &nbsp;&nbsp;&nbsp;&nbsp; ClassicBatchComputeWorkerMgr.getWorkerName(self, workerID)
        Return a string which uniquely identifies each work, including
        the jobName, if given.

#### &nbsp;&nbsp;&nbsp;&nbsp; ClassicBatchComputeWorkerMgr.makeOutObjList(self)
        Make a list of all the objects the workers put into outqueue
        on completion

#### &nbsp;&nbsp;&nbsp;&nbsp; ClassicBatchComputeWorkerMgr.setJobName(self, jobName)
        Sets the job name string, which is made available to worker
        processes. Defaults to None, and has only cosmetic effects.

#### &nbsp;&nbsp;&nbsp;&nbsp; ClassicBatchComputeWorkerMgr.setupNetworkCommunication(self, userFunction, infiles, outfiles, otherArgs, controls, workinggrid, allInfo, blockList, numWorkers, inBlockBuffer, outBlockBuffer, forceExit, exceptionQue, workerBarrier)
        Set up the standard methods of network communication between
        the workers and the main thread. This is expected to be the
        same for all workers running on separate machines from the
        main thread.
...
#### &nbsp;&nbsp;&nbsp;&nbsp; ECSComputeWorkerMgr.getWorkerName(self, workerID)
        Return a string which uniquely identifies each work, including
        the jobName, if given.
...
#### &nbsp;&nbsp;&nbsp;&nbsp; ECSComputeWorkerMgr.makeOutObjList(self)
        Make a list of all the objects the workers put into outqueue
        on completion
...
#### &nbsp;&nbsp;&nbsp;&nbsp; ECSComputeWorkerMgr.setJobName(self, jobName)
        Sets the job name string, which is made available to worker
        processes. Defaults to None, and has only cosmetic effects.

#### &nbsp;&nbsp;&nbsp;&nbsp; ECSComputeWorkerMgr.setupNetworkCommunication(self, userFunction, infiles, outfiles, otherArgs, controls, workinggrid, allInfo, blockList, numWorkers, inBlockBuffer, outBlockBuffer, forceExit, exceptionQue, workerBarrier)
        Set up the standard methods of network communication between
        the workers and the main thread. This is expected to be the
        same for all workers running on separate machines from the
        main thread.
...
### class SubprocComputeWorkerManager
...
#### &nbsp;&nbsp;&nbsp;&nbsp; SubprocComputeWorkerManager.getWorkerName(self, workerID)
        Return a string which uniquely identifies each work, including
        the jobName, if given.

#### &nbsp;&nbsp;&nbsp;&nbsp; SubprocComputeWorkerManager.makeOutObjList(self)
        Make a list of all the objects the workers put into outqueue
        on completion

#### &nbsp;&nbsp;&nbsp;&nbsp; SubprocComputeWorkerManager.setJobName(self, jobName)
        Sets the job name string, which is made available to worker
        processes. Defaults to None, and has only cosmetic effects.

#### &nbsp;&nbsp;&nbsp;&nbsp; SubprocComputeWorkerManager.setupNetworkCommunication(self, userFunction, infiles, outfiles, otherArgs, controls, workinggrid, allInfo, blockList, numWorkers, inBlockBuffer, outBlockBuffer, forceExit, exceptionQue, workerBarrier)
        Set up the standard methods of network communication between
        the workers and the main thread. This is expected to be the
        same for all workers running on separate machines from the
        main thread.
...
### class ThreadsComputeWorkerMgr
      Manage compute workers using threads within the current process.

#### &nbsp;&nbsp;&nbsp;&nbsp; ThreadsComputeWorkerMgr.\_\_init\_\_(self)
        Initialize self.  See help(type(self)) for accurate signature.

#### &nbsp;&nbsp;&nbsp;&nbsp; ThreadsComputeWorkerMgr.getWorkerName(self, workerID)
        Return a string which uniquely identifies each work, including
        the jobName, if given.

#### &nbsp;&nbsp;&nbsp;&nbsp; ThreadsComputeWorkerMgr.makeOutObjList(self)
        Make a list of all the objects the workers put into outqueue
        on completion

#### &nbsp;&nbsp;&nbsp;&nbsp; ThreadsComputeWorkerMgr.setJobName(self, jobName)
        Sets the job name string, which is made available to worker
        processes. Defaults to None, and has only cosmetic effects.

#### &nbsp;&nbsp;&nbsp;&nbsp; ThreadsComputeWorkerMgr.setupNetworkCommunication(self, userFunction, infiles, outfiles, otherArgs, controls, workinggrid, allInfo, blockList, numWorkers, inBlockBuffer, outBlockBuffer, forceExit, exceptionQue, workerBarrier)
        Set up the standard methods of network communication between
        the workers and the main thread. This is expected to be the
        same for all workers running on separate machines from the
        main thread.
