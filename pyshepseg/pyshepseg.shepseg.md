...
### def eliminateSmallSegments(seg, img, maxSegId, minSegSize, maxSpectralDiff, fourConnected, minSegId)
...
### def findMergeSegment(segId, segLoc, seg, segSize, spectSum, maxSpectralDiff, fourConnected)
...
## Values
    MINSEGID = 1
    RowColArray_Type = instance.jitclass.RowColArray#783338e51010<idx:uint32,rowcols:array(uint32, 2d, A)>
    SEGNULLVAL = 0
